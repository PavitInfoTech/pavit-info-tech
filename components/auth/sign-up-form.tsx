...
import { calculatePasswordStrength, isEmailValid, isPasswordValid } from "@/lib/auth-utils"
  ...
  return (
    <Card className="p-8 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Join PavitInfoTech and start monitoring your IoT infrastructure</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {formData.password && <PasswordStrengthIndicator {...passwordStrength} />}
