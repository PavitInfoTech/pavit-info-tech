...
import { LayoutDashboard, Zap, BarChart3, Settings, LogOut, Menu, X } from "lucide-react"
    ...
    <>
      ...
      >
        ...
        <div className="h-16 flex items-center px-6 border-b border-sidebar-border">
          <Link href="/dashboard" className="flex items-center space-x-2 font-serif font-bold text-lg">
            <div className="w-8 h-8 bg-gradient-to-br from-sidebar-primary to-secondary rounded-lg" />
