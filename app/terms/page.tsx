      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 mt-16'>
        ...
        <div className='prose prose-invert max-w-none space-y-8'>
          ...
          <ul>
            ...
            <li>
              <strong>Website</strong> refers to PavitInfoTech, accessible from{" "}
              <a
                href='https://pavitinfotech.com/'
                rel='external nofollow noopener'
                target='_blank'
              >
                https://pavitinfotech.com/
              </a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              <a
                href='https://pavitinfotech.com/contact/'
                rel='external nofollow noopener'
                target='_blank'
              >
                https://pavitinfotech.com/contact/
              </a>
            </li>
            <li>By phone: 0768924153</li>
          </ul>
        </div>
      </div>
    </MainLayout>
