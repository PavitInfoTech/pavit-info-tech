      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 mt-16'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto text-pretty'>
            We&#39;re on a mission to transform how enterprises manage and
            optimize their IoT infrastructure through intelligent AI analytics.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-16'>
          <Card className='p-8 bg-accent/5'>
            ...
            <p className='text-muted-foreground'>
              To bring intelligence, automation, and reliability to IoT
              operations, enabling enterprises to make data-driven decisions and
          ...
          <Card className='p-8 bg-secondary/5'>
            ...
            <p className='text-muted-foreground'>
              Smarter, data-driven ecosystems powered by real-time AI insights
              that automatically detect issues, predict failures, and optimize
              operations.
            </p>
          </Card>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            {[
              ...
              },
              {
                title: "Innovation",
                description:
                  "We continuously advance AI and IoT technologies to solve complex real-world challenges.",
              },
              {
                title: "Trust & Security",
                description:
                  "We prioritize data security and customer trust as the foundation of our platform.",
              },
            ].map((value) => (
