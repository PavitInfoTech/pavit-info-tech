      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 mt-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p>
              PavitInfoTech ("Company", "we", "our", or "us") operates the PavitInfoTech.com website and IoT platform
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">2.1 Types of Data Collected</h3>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                address), browser type, browser version, the pages you visit, the time and date of your visit, and other
                diagnostic data.
              </li>
              <li>
                <strong>Device Data:</strong> Data collected from IoT devices and sensors connected to our platform,
                including device metrics, sensor readings, and operational data.
              </li>
            </ul>
          </section>
