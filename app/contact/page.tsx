      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 mt-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Have questions about PavitInfoTech? Our team is here to help you get started.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <Card className="p-6">
              ...
              <p className="text-muted-foreground text-sm">Response time: 2 hours</p>
            </Card>

            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-2">Sales</h3>
              <p className="text-muted-foreground">sales@pavitinfotech.com</p>
              <p className="text-muted-foreground text-sm">For enterprise inquiries</p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-muted-foreground text-sm">9 AM - 6 PM PT for other plans</p>
            </Card>
          </div>
            ...
            <Card className="p-8">
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea placeholder="Tell us about your needs..." rows={6} />
                </div>
