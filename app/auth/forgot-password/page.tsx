        ...
        <div className="w-full max-w-md">
          <Card className="p-8 space-y-6">
            {!submitted ? (
              <>
                <div>
                  <h1 className="text-2xl font-bold font-serif mb-2">Reset Password</h1>
                ...
                <Link href="/auth/signin" className="flex items-center gap-2 text-sm text-primary hover:underline">
              ...
              <div className="text-center space-y-4">
                ...
                <h2 className="text-xl font-bold font-serif">Check Your Email</h2>
